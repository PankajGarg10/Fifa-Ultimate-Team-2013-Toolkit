...
namespace UltimateTeam.Toolkit.Parameter
{
    public class League : SearchParameterBase<uint>
    {
        ...
        public const uint PrimeraLiga = 353;
        ...
        public static IEnumerable<League> GetAll()
        {
            ...
            yield return new League("Primera Liga", PrimeraLiga);
            ...
            yield return new League("Scotland League", Spl);
            ...
            yield return new League("TürkLig", TurkLig);
        }
    }
}
